 ...
 * @author cesar_000
 */
public class IExperiment1Result extends javax.swing.JFrame {

    /**
     * Creates new form IExperiment1Result
     */
    Controller controller;
    ResultFirstExperiment experiment;
    public IExperiment1Result(Controller controller) {
        this.controller = controller;
        initComponents();
    }

    private IExperiment1Result() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Experiment # 1 - Results");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        controller.backToExperiment1();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        controller.graphFirstResul(experiment);
    }//GEN-LAST:event_jButton2ActionPerformed

    public void setResult(String result) {                                         
        jLabelResult.setText(result);
    }
    public void setExperiment(ResultFirstExperiment experiment) {                                         
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IExperiment1Result.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IExperiment1Result().setVisible(true);
            }
        });
    }
